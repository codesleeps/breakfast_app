...
const MOCK_MENU_ITEMS = [
  // Main dishes - Hot
  { id: '1', name: 'Kitchen Special', description: '2 x fried eggs, 4 x fish fingers, baked beans, fried plantains and 3 x fried dumplings', price_pence: 450, category: 'Hot', image_url: '/kitchen_special.jpg', available: true, sort_order: 1, is_extra: false },
  { id: '2', name: 'Scrambled Eggs with Flatbread', description: 'Fluffy scrambled eggs served with homemade flatbread', price_pence: 350, category: 'Hot', image_url: '/open_flatbread.jpg', available: true, sort_order: 2, is_extra: false },
