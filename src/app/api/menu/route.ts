...
const MOCK_MENU_ITEMS = [
  { id: '1', name: 'Kitchen Special', description: '2 x fried eggs, 4 x fish fingers, baked beans, fried plantains and 3 x fried dumplings', price_pence: 450, category: 'Hot', image_url: '/kitchen_special.jpg', available: true, sort_order: 1 },
  { id: '2', name: 'Scrambled Eggs on Toast', description: 'Fluffy scrambled eggs on toasted sourdough', price_pence: 350, category: 'Hot', image_url: 'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=200&h=200&fit=crop', available: true, sort_order: 2 },
